(function() {
  ...
  var players = global.sm2BarPlayers;

  var Player = global.SM2BarPlayer;
  ...
  utils = {
    ...
    events: (function() {
      ...
      remove = (global.removeEventListener !== undefined ? function(o, evtName, evtHandler) {
  ...
  soundManager.onready(function() {
      ...
      utils.events.add(demoData.colorPicker, 'click', function(e) {
        ...
        changeHandler = utils.events.add(demoData.colorPicker, 'change', function(e) {
          ...
          if (colorTimer) {
            global.clearInterval(colorTimer);
            colorTimer = null;
          }
        ...
        colorTimer = global.setInterval(function() {
